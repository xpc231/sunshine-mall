...
public class RocketMQConfig {
    ...
    public RocketMQTemplate rocketMQTemplate() {
        ...
        log.info("[pay-service] RocketMQTemplate 初始化完成 - nameServer: {}, producerGroup: {}", nameServer, producerGroup);
        return template;
    }
    ...
    private org.apache.rocketmq.client.producer.DefaultMQProducer createDefaultProducer() {
        ...
        log.info("[pay-service] RocketMQ Producer 配置完成");
        return producer;
    }
}
